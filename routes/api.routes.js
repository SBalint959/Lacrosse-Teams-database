...
router.get('/USA', async function (req, res, next) {
   const sqlPodaci = `SELECT * FROM topplayerteams NATURAL JOIN topplayers 
                      WHERE topplayerteams.country= 'USA'`;
...
router.get('/players', async function (req, res, next) {
   const sqlPodaci = `SELECT * FROM topplayers`;
...
router.get('/teams', async function (req, res, next) {
   const sqlPodaci = `SELECT teamname,teamid, country, city, eastorwest, yearfounded, coach, 
                     ...
                     FROM topplayerteams  
                        GROUP BY teamid, teamname, country, city, eastorwest, yearfounded, coach, 
                        placedlastseason, winloserecordlastseason, previouslybestplaced, numberoftitles
                     ORDER BY teamid`;
